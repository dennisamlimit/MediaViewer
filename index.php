...
<head>
    ...
    <meta property="og:url" content="https://media.dennisamlimit.dev/<?php echo urlencode($filename); ?>">
    <meta property="og:image" content="https://media.dennisamlimit.dev/media/<?php echo urlencode($filename); ?>">
